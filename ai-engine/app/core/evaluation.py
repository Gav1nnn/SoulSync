...
from core.schemas import GenerateResponse
from core.persona import PersonaProfile


def build_generate_response(*, reply: str, character_name: str, persona: PersonaProfile, llm_provider: str | None = None,) -> GenerateResponse:
